...
const addition = catchAsyncBusinessError(async (number1, number2) => {
    logger.info(`additionBusinessService.addition called with number1=${number1} and number2=${number2}`);
